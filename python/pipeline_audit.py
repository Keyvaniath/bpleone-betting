...
ARTIFACTS: List[Dict[str, Any]] = [
    ...
    # === DEEP DATA: historical + rosters + game logs + self-training ===
    {"name": "historical_nba.json",       "cadence_mins":  8*60},
    {"name": "historical_nhl.json",       "cadence_mins":  8*60},
    {"name": "historical_wnba.json",      "cadence_mins":  8*60},
    {"name": "historical_mls.json",       "cadence_mins":  8*60},
    {"name": "historical_epl.json",       "cadence_mins":  8*60},
    {"name": "historical_cws.json",       "cadence_mins":  8*60},
    {"name": "historical_mlb.json",       "cadence_mins":  8*60},
    {"name": "historical_nfl.json",       "cadence_mins":  8*60, "optional": True},
    {"name": "historical_ncaaf.json",     "cadence_mins":  8*60, "optional": True},
    {"name": "team_form_nba.json",        "cadence_mins":  8*60},
    {"name": "team_form_nhl.json",        "cadence_mins":  8*60},
    {"name": "team_form_wnba.json",       "cadence_mins":  8*60},
    {"name": "team_form_mls.json",        "cadence_mins":  8*60},
    {"name": "team_form_epl.json",        "cadence_mins":  8*60},
    {"name": "team_form_cws.json",        "cadence_mins":  8*60},
    {"name": "h2h_nba.json",              "cadence_mins":  8*60},
    {"name": "h2h_nhl.json",              "cadence_mins":  8*60},
    {"name": "h2h_wnba.json",             "cadence_mins":  8*60},
    {"name": "h2h_mls.json",              "cadence_mins":  8*60},
    {"name": "h2h_epl.json",              "cadence_mins":  8*60},
    {"name": "h2h_cws.json",              "cadence_mins":  8*60},
    {"name": "h2h_mlb.json",              "cadence_mins":  8*60},
    {"name": "rosters_nba.json",          "cadence_mins": 24*60},
    {"name": "rosters_wnba.json",         "cadence_mins": 24*60},
    {"name": "rosters_nhl.json",          "cadence_mins": 24*60},
    {"name": "rosters_nfl.json",          "cadence_mins": 24*60},
    {"name": "player_stats_nba.json",     "cadence_mins":  8*60},
    {"name": "player_stats_wnba.json",    "cadence_mins":  8*60},
    {"name": "player_stats_nhl.json",     "cadence_mins":  8*60},
    {"name": "real_player_props_nba.json", "cadence_mins":  8*60},
    {"name": "real_player_props_wnba.json","cadence_mins":  8*60},
    {"name": "real_player_props_nhl.json", "cadence_mins":  8*60},
    {"name": "self_training_nba.json",    "cadence_mins":  8*60},
    {"name": "self_training_nhl.json",    "cadence_mins":  8*60},
    {"name": "self_training_wnba.json",   "cadence_mins":  8*60},
    {"name": "self_training_mls.json",    "cadence_mins":  8*60},
    {"name": "self_training_epl.json",    "cadence_mins":  8*60},
    ...
    {"name": "clv_multi.json",            "cadence_mins":  8*60},
    {"name": "heat_cold_alerts.json",     "cadence_mins":  8*60},
    {"name": "pregame_alerts.json",       "cadence_mins":  8*60},
    {"name": "mlb_batter_logs.json",      "cadence_mins":  8*60},
    {"name": "mlb_batter_heat.json",      "cadence_mins":  8*60},
    {"name": "mlb_extended_props.json",   "cadence_mins":  8*60},
    ...
    {"name": "slate_team_pot.json",       "cadence_mins":  8*60},
    {"name": "todays_top_plays.json",     "cadence_mins":  8*60},
    ...
    {"name": "ufc_matchup.json",          "cadence_mins": 24*60, "optional": True},
    {"name": "ufc_method_of_victory.json","cadence_mins": 24*60, "optional": True},
    {"name": "golf_player_heat.json",     "cadence_mins": 24*60, "optional": True},
    {"name": "golf_region_props.json",    "cadence_mins": 24*60, "optional": True},
    {"name": "ats_tracker_nba.json",      "cadence_mins":  8*60},
    {"name": "ats_tracker_nhl.json",      "cadence_mins":  8*60},
    {"name": "ats_tracker_wnba.json",     "cadence_mins":  8*60},
    {"name": "ats_tracker_mls.json",      "cadence_mins":  8*60},
    {"name": "ats_tracker_epl.json",      "cadence_mins":  8*60},
    {"name": "ats_tracker_mlb.json",      "cadence_mins":  8*60},
    {"name": "ats_tracker_cws.json",      "cadence_mins":  8*60},
    {"name": "multi_sport_correlation.json","cadence_mins":  8*60},
    {"name": "prediction_log.json",       "cadence_mins":  8*60},
    {"name": "anomaly_alerts.json",       "cadence_mins":  8*60},
    {"name": "survivor_pool.json",        "cadence_mins":  8*60, "optional": True},
    {"name": "daily_summary_v2.md",       "cadence_mins":  8*60},
    {"name": "daily_summary_v2.json",     "cadence_mins":  8*60},
    {"name": "mlb_pitcher_logs.json",     "cadence_mins":  8*60},
    {"name": "mlb_pitcher_matchup.json",  "cadence_mins":  8*60},
    {"name": "convergence_alerts.json",   "cadence_mins":  8*60},
    {"name": "b2b_fatigue.json",          "cadence_mins":  8*60},
    {"name": "streak_regression.json",    "cadence_mins":  8*60},
    {"name": "model_health.json",         "cadence_mins":  8*60},
    {"name": "training_convergence.json", "cadence_mins":  8*60},
    {"name": "live_momentum.json",        "cadence_mins":  20, "optional": True},
    {"name": "momentum_history.json",     "cadence_mins":  20, "optional": True},
    {"name": "data_health.json",          "cadence_mins":  30},
