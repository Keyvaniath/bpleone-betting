...
DEFAULT_MODULES = [
    ...
    "mlb_starter_form_regression_detector",
    "mlb_starter_recent_form_index",
    "mlb_pitcher_k_streak_tracker",
    ...
    "nba_pace_mismatch_alerts",
    "nba_garbage_time_alerts",
    "nba_game_preview",
    "nba_two_way_alignment",
    "nba_player_rest_alerts",
    "nba_player_clutch_index",
    "nba_50_burger_watchlist",
