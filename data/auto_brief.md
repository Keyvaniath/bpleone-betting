...
_30% lineups confirmed · 5 rookie SPs_
**Recommendation:** Slightly smaller bets; skip pre-cal edges (>15%).

## Slate
- **5 games** scheduled
- **22 best bets** scored: 0 DK · 0 PP · 4 NRFI · 0 SGP
- **Auto-portfolio:** 2 picks, $100.0 stake (10.0%), expected +$42.47
- **MC simulation:** EV +$54.4, 78% P(profit), p05 $-84.97 / p95 $164.01

## Top 5 Best Bets
1. **TBR @ TOR YRFI (1st-inning OVER 0.5)**  (80/100 ****, edge +31.2%)
   - P(YRFI) 77.2% vs baseline 46.0%
2. **KCR @ DET NRFI (no run 1st inning)**  (78/100 ****, edge +18.1%)
...
- **SDP @ ATL YRFI (1st-inning OVER 0.5)** (low):
   - Edge +13.1% looks big but only 0 settled props on this player — model unproven
...
- **YRFI** (1st-inning OVER): TBR @ TOR, MIN @ CLE, SDP @ ATL
...
## Player Play of the Day -- across all sports (3649 candidates scanned)
...
- **LOL:** 36 settled | brier 0.2648 | ECE 0.1627
   - Model over-confident; subtract 14.6pp at next inference
- **KBO:** 27 settled | brier 0.3145 | ECE 0.3447
   - Model over-confident; subtract 34.5pp at next inference
