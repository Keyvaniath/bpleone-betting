...
2. **BAL @ TBR YRFI (1st-inning OVER 0.5)**  (80/100 ****, edge +23.3%)
   - P(YRFI) 69.3% vs baseline 46.0%
3. **PHI @ MIN YRFI (1st-inning OVER 0.5)**  (80/100 ****, edge +20.2%)
   - P(YRFI) 66.2% vs baseline 46.0%
4. **SDP @ CLE YRFI (1st-inning OVER 0.5)**  (80/100 ****, edge +20.0%)
   - P(YRFI) 66.0% vs baseline 46.0%
5. **LOL Inspired UNDER 3.5 Kills**  (78/100 ****, edge —)
   - Player prop quality score 1.1935
   - Elite player

## ⚠️ Trap Warnings — 31 flagged
- **Nick Fortes OVER 0.5 batter hits** (high):
   - Edge +11.7% looks big but only 0 settled props on this player — model unproven
   - Batter cooling: cooling: 0.381 ops recent vs 0.683 season (-0.302)
- **Connor Wong OVER 0.5 batter hits** (high):
   - Edge +10.6% looks big but only 0 settled props on this player — model unproven
   - Batter cooling: cooling: 0.476 ops recent vs 0.684 season (-0.208)
- **Ben Rice OVER 0.5 batter hits** (high):
   - Edge +8.9% looks big but only 0 settled props on this player — model unproven
   - Batter cooling: cooling: 0.421 ops recent vs 0.875 season (-0.454)
- **Ryan McMahon OVER 0.5 batter hits** (low):
...
- **YRFI** (1st-inning OVER): WSN @ NYM, BAL @ TBR, PHI @ MIN, SDP @ CLE, COL @ SFG

## Golf -- FedEx St. Jude Championship
- **Leader:** Scottie Scheffler (-13) at #1
- **Field:** 69 players  |  Status: In Progress
- **Play of the Tournament:** Sam Burns WIN @ +609 (model 14.1%, HIGH)
   - P(win) 14.1% with 1 round(s) left -- sweet-spot value at #2 (-11).
...
- **LOL:** 59 settled | brier 0.2625 | ECE 0.1267
   - Model over-confident; subtract 11.2pp at next inference
- **KBO:** 52 settled | brier 0.2743 | ECE 0.1839
