# EdgeStat Daily Summary — 2026-05-21

## 🏥 Model Health: 82.8/100 [HEALTHY]
...
- **Strong home favorites:** 12 | **Strong road dogs:** 8
...
- [WHALE] **[MLB]** ATL @ MIA ML_AWAY -- 68% / +15.6% (score 3.5)

## 📡 Sharp Action (Line Movement)
- [STRONG] **NYM @ WSN** ml_home: 45.45% → 51.92% (+6.5pp)
- [STRONG] **ATL @ MIA** ml_away: 52.15% → 58.33% (+6.2pp)
...
- [WNBA] **Toronto Tempo** AWAY (3-2 L10) · model 65.8% fair -192
- [EPL] **Sunderland** HOME (1-2 L10) · model 65.3% fair -188
- [MLS] **CF Montréal** AWAY (1-3 L10) · model 63.6% fair -175

## 🔥/❄️ Heat / Cold Signals
- Hot teams: **27** | Cold teams: **39** | Over-heavy: 0 | Under-heavy: 13
- Heating-up players: **20** | Cooling-down: 20

## ⚠️ Anomaly Detector (14)
- RESIDUAL_DIVERGENCE: **14**
  - New York Knicks (NBA): New York Knicks OUTPERFORMING expected margin by 9.9pts in recent games -- model bias may persist
  - Montreal Canadiens (NHL): Montreal Canadiens UNDERPERFORMING expected margin by 10.8pts in recent games -- model bias may persist
  - New York Liberty (WNBA): New York Liberty OUTPERFORMING expected margin by 6.8pts in recent games -- model bias may persist
  - Golden State Valkyries (WNBA): Golden State Valkyries OUTPERFORMING expected margin by 7.0pts in recent games -- model bias may persist
...
- **Casey Mize** OVER 4.5 K (71%) fair -251
- **Cade Cavalli** OVER 4.5 K (71%) fair -251
- **José Soriano** OVER 5.5 K (70%) fair -233
- **Spencer Strider** OVER 4.5 K (69%) fair -221
- **Braxton Ashcraft** OVER 5.5 K (65%) fair -184
...
## ⛳ Golf Player Heat (from THE CJ CUP Byron Nelson)
  ...
  - 🔥 T3 **Keith Mitchell** (USA): -7 total -- finished T3
  - 🔥 T4 **Michael Thorbjornsen** (USA): -7 total -- finished T4
  - 🔥 T5 **Doug Ghim** (USA): -6 total -- finished T5

## 🔥 MLB Batter Heat (27 HOT / 46 COLD)
  - 🔥 **Blaze Alexander** (BAL): L14 .379 / season .235 (+144pts)
  - 🔥 **Alec Bohm** (PHI): L14 .353 / season .220 (+133pts)
  - 🔥 **Carson Benge** (NYM): L14 .383 / season .264 (+119pts)
  - 🔥 **Cedric Mullins** (TB): L14 .283 / season .181 (+102pts)
  - 🔥 **Riley Greene** (DET): L14 .429 / season .328 (+101pts)
  - ❄️ **Moisés Ballesteros** (CHC): L14 .067 / season .243 (-176pts) -- FADE props
  - ❄️ **Ozzie Albies** (ATL): L14 .132 / season .276 (-144pts) -- FADE props
  - ❄️ **Christian Walker** (HOU): L14 .118 / season .255 (-137pts) -- FADE props
  - ❄️ **Edouard Julien** (COL): L14 .079 / season .216 (-137pts) -- FADE props
  - ❄️ **Vladimir Guerrero Jr.** (TOR): L14 .146 / season .281 (-135pts) -- FADE props
...
- ELITE: **7** · HEALTHY: 1 · OK: 0 · DEGRADED: **0**

## 🤖 Self-Training Status
- **NBA**: n=18 games · hit rate 61.1% · bias -4.5pp [calibration applied]
- **NHL**: n=16 games · hit rate 56.2% · bias +20.4pp [calibration applied]
- **WNBA**: n=34 games · hit rate 23.5% · bias +20.1pp [calibration applied]
- **MLS**: n=59 games · hit rate 33.9% · bias +6.9pp [calibration applied]
- **EPL**: n=31 games · hit rate 45.2% · bias -10.9pp [calibration applied]
- **MLB**: n=190 games · hit rate 52.1% · bias -1.8pp
- **CWS**: n=334 games · hit rate 54.2% · bias -2.2pp [calibration applied]
