# EdgeStat Daily Brief - 2026-08-18

**Model Confidence: 19.3/100 [RED]** -- Calibration warming up. Research signal only; no real-money sizing yet.
...
- **2-leg @ +478 (prob 25.1%, EV +45.4%)**
  - SFG @ CLE SFG_ML (+164, model 46.7%)
  - SDP @ NYM NYM_ML (+119, model 53.8%)
- **2-leg @ +445 (prob 26.6%, EV +45.12%)**
  - SDP @ NYM NYM_ML (+119, model 53.8%)
  - CHW @ CHC CHW_ML (+149, model 49.4%)
- **2-leg @ +404 (prob 28.7%, EV +44.66%)**
  - SFG @ CLE SFG_ML (+164, model 46.7%)
  - SDP @ NYM UNDER_8.5 (-110, model 61.5%)
- **2-leg @ +415 (prob 28.1%, EV +44.53%)**
  - SDP @ NYM NYM_ML (+119, model 53.8%)
  - OAK @ KCR OAK_ML (+135, model 52.2%)
- **2-leg @ +375 (prob 30.4%, EV +44.39%)**
  - SDP @ NYM UNDER_8.5 (-110, model 61.5%)
  - CHW @ CHC CHW_ML (+149, model 49.4%)
...
| TOR @ TBR | 55.2% | -123 | 2.97 | -117 | +117 |
| WSN @ TEX | 34.8% | +187 | 5.28 | +324 | -324 |

## Travel / Rest Flags

- **SFG @ CLE** (away): 2 days rest (+3h tz)
- **SEA @ MIL** (home): 2 days rest (+2h tz)
- **WSN @ TEX** (home): 2 days rest (+2h tz)
- **LAA @ HOU** (away): 2 days rest (+2h tz)

## Team Form (last 10)

**Hot:** MIA 6-4 (L1, +19), STL 6-4 (W1, +16), SD 7-3 (L1, +15), TB 7-3 (W1, +12), PHI 6-4 (W4, +8)

**Cold:** CIN 4-6 (L1, -24), ATH 4-6 (L1, -21), SEA 3-7 (W2, -20), SF 3-7 (L1, -17), TEX 4-6 (L1, -14)

## Gassed Bullpens (> 8.0 IP in 2 days)

- PIT: 12.0 IP across 2 games
...
_Source: github.com/Keyvaniath/bpleone-betting - last settled 2026-08-18._